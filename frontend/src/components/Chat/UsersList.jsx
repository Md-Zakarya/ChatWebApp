...
export default function UsersList() {
  ...
  return (
    <div
      className={`min-h-screen flex flex-col shadow-lg ${
          ...
          <div className="relative">
            <button
              ...
              className={`p-2 rounded-full transition-colors ${
                darkMode ? "hover:bg-gray-700/10" : "hover:bg-white/10"
              }`}
            >
              <svg
                className={`w-5 h-5 ${
            ...
            {showProfileMenu && (
              <div
                className={`absolute right-0 mt-2 w-48 rounded-lg shadow-lg border z-50 animate-fadeIn ${
                  darkMode
            ...
            {pendingRequests.map((request) => (
              ...
              >
                ...
                <div className="space-x-2">
                  <button
                    onClick={() =>
                      respondToRequest(request.from._id, "accepted")
                    }
                  ...
                  <button
                    onClick={() =>
                      respondToRequest(request.from._id, "rejected")
                    }
